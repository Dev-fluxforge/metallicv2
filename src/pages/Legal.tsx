  ...
  return (
    <div className="pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="prose prose-invert max-w-none space-y-12 text-white/60 font-light leading-relaxed">
          <section className="space-y-6">
            <h2 className="text-3xl text-white font-display uppercase tracking-wider">1. Introduction</h2>
          ...
          <section className="space-y-6">
            <h2 className="text-3xl text-white font-display uppercase tracking-wider">2. Product Information</h2>
          ...
          <section className="space-y-6">
            <h2 className="text-3xl text-white font-display uppercase tracking-wider">3. Shipping & Delivery</h2>
          ...
          <section className="space-y-6">
            <h2 className="text-3xl text-white font-display uppercase tracking-wider">4. Returns & Refunds</h2>
          ...
          <section className="space-y-6">
            <h2 className="text-3xl text-white font-display uppercase tracking-wider">5. Privacy & Data</h2>
          ...
          <section className="space-y-6">
            <h2 className="text-3xl text-white font-display uppercase tracking-wider">6. Contact Information</h2>
